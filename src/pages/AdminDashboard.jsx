          ...
          {submittedReports.map((entry, i) => (
            <div key={i} className="bg-gray-100 p-4 rounded-lg shadow-sm">
              ...
              <p className="text-sm mt-2">
                <strong>Attendance:</strong> {entry.report.attendance}
              </p>
              <p className="text-sm">
                <strong>Kit Used:</strong> {entry.report.kitUsed}
              </p>
              <p className="text-sm mb-2">
                <strong>Notes:</strong> {entry.report.notes}
              </p>

              <button
                onClick={() => window.print()} // Temporary export
